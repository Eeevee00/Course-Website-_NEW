...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		else
		{
			...
			$this->load->view('header-admin-logged');
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				if ($this->ion_auth->is_admin()){
					...
					// redirect('', 'refresh');
					$this->load->view('header-admin-logged');
					$this->load->view('content-main-admin');
					...
					$this->load->view('header-user-logged');
					$this->load->view('content-main-user',$data);
					$this->load->view('footer');
				}
	...
	*/
	...
	public function delete_user($id)
	{
		...
		else
		{
			...
			// set the flash data error message if there is one
			$this->data['message'] = 'User Successfully Deleted';
			...
			$this->load->view('header-admin-logged');
			$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'index', $this->data, $message);
			$this->load->view('footer-no-js');
		}
	}
