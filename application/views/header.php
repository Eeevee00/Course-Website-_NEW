...
<body>
  ...
  <div id="preloader">
    <div class="loader">
      ...
      <img src="<?=base_url()?>/assets/img/ums_logo_big.png" alt="">
    </div>
  </div>
  ...
  <section class="navigation_bar">
    <nav class="navbar navbar-dark navbar-expand-md fixed-top d-lg-flex justify-content-lg-center">
      <div class="navbar-container container"><a class="navbar-brand page-title" href="<?=base_url()?>"><img src="<?=base_url()?>assets/img/fci_logo.png"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navcol">
          <ul class="navbar-nav d-lg-flex flex-grow-1 justify-content-between justify-content-lg-end header-nav-items">

            <li class="nav-item links"><a class="nav-link" href="#news">News</a></li>
            <li class="nav-item links"><a class="nav-link" href="#campus">Campus</a></li>
            <li class="nav-item links"><a class="nav-link" href="#about">About</a></li>
            <li class="nav-item links"><a class="nav-link" href="#programs">FAQ</a></li>
            <li class="nav-item links"><a class="nav-link" href="<?=base_url()?>index.php/auth/login" style="background-color:#133d9e; border-radius:5px;">Login</a></li>
