...
<body>
  ...
  <section class="navigation_bar">
    <nav class="navbar navbar-dark navbar-expand-md fixed-top d-lg-flex justify-content-lg-center">
      <div class="navbar-container container"><a class="navbar-brand page-title" href="<?=base_url()?>Students"><img src="<?=base_url()?>assets/img/fci_logo.png"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navcol">
          <ul class="navbar-nav d-lg-flex flex-grow-1 justify-content-between justify-content-lg-end header-nav-items">

            <li class="nav-item links"><a class="nav-link" href="<?=base_url()?>Students/student_profile">My Profile</a></li>
            <li class="nav-item links"><a class="nav-link" href="<?=base_url()?>Students/course_registered">My Courses</a></li>
            <li class="nav-item links"><a class="nav-link" href="<?=base_url()?>Students/student_result">My Results</a></li>
            <li class="nav-item links"><a class="nav-link" href="<?=base_url()?>Students/student_finance">My Finance</a></li>
            <li class="nav-item links"><a class="nav-link" href="<?=base_url()?>Students/view_examdate">Examination</a></li>
            <li class="nav-item links"><a class="nav-link" href="<?=base_url()?>File_Complaint/" >Feedback</a></li>
